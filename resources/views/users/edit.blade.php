    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold m-0 text-dark">Modifier l'Utilisateur</h2>
                    <p class="text-muted small m-0">Mettez à jour les détails du compte de {{ $user->nom }}.</p>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="password" class="form-label fw-semibold">Changer le Mot de passe</label>
                                <input type="password" name="password" id="password" class="form-control" placeholder="Laissez vide si vous ne souhaitez pas modifier">
                            </div>

                            <div class="col-md-6">
                                <label for="confirm-password" class="form-label fw-semibold">Confirmer Nouveau Mot de passe</label>
                                <input type="password" name="confirm-password" id="confirm-password" class="form-control" placeholder="Confirmation">
                            </div>
