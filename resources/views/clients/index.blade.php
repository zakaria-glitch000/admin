                    ...
                    <div class="col-md-9">
                        <div class="search-box">
                            <div class="position-relative">
                                <input type="text" name="search" id="filterSearch" class="form-control" placeholder="Rechercher par nom, email, téléphone..." value="{{ request('search') }}">
                                ...
                                <tr class="clickable-row" data-href="{{ route('clients.show', $client) }}">
                                    ...
                                    <td data-column="sites">
                                        <span class="badge bg-soft-info text-info font-size-12">
                                            {{ $client->computed_total_sites ?? $client->sites->count() }} site(s)
                                        </span>
                                    </td>
                                    ...
                                    <td data-column="contrat">
                                        <div class="d-flex flex-column gap-1">
                                            <div>
                                                <span class="badge bg-soft-{{ $client->etat_contrat_color ?? 'secondary' }} text-{{ $client->etat_contrat_color ?? 'secondary' }} font-size-11">
                                            ...
                                            @if($total > 0)
                                                <small class="text-muted font-size-11">
                                                    <span class="text-success fw-bold">{{ $actifs }} sous contrat</span> / 
                                                    <span class="text-danger fw-bold">{{ $expires }} Expirée</span>
                                                </small>
                                            @endif
                                        </div>
                                    </td>
