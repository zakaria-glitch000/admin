...
<?php $__env->startSection('title'); ?> Liste des Tickets <?php $__env->stopSection(); ?>
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <a href="<?php echo e(route('tickets.create')); ?>" class="btn btn-primary"><i class="bx bx-plus me-1"></i> Nouveau Ticket</a>
        </div>
    </div>
</div>
...
<ul class="nav nav-tabs nav-tabs-custom mb-3" role="tablist">
    <li class="nav-item">
        <a class="nav-link <?php echo e(($tab ?? 'en_cours') == 'en_cours' ? 'active fw-bold' : ''); ?>" 
            href="<?php echo e(route('tickets.index', array_merge(request()->except('tab'), ['tab' => 'en_cours']))); ?>">
            <i class="bx bx-time-five me-1"></i> Tickets En Cours
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo e(($tab ?? '') == 'cloturees' ? 'active fw-bold' : ''); ?>" 
            href="<?php echo e(route('tickets.index', array_merge(request()->except('tab'), ['tab' => 'cloturees']))); ?>">
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="filterForm" action="<?php echo e(route('tickets.index')); ?>" method="GET" class="row g-3">
                    <input type="hidden" name="tab" value="<?php echo e($tab ?? 'en_cours'); ?>">

                    <div class="col-md-3">
                        <input type="text" name="search" id="filterSearch" class="form-control form-control-sm" placeholder="Référence ou titre..." value="<?php echo e(request('search')); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <select name="status_id" id="filterStatus" class="form-select form-select-sm">
                            ...
                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($status->id); ?>" <?php echo e(request('status_id') == $status->id ? 'selected' : ''); ?>><?php echo e($status->nom); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <select name="priority_id" id="filterPriority" class="form-select form-select-sm">
                            ...
                            <?php $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($priority->id); ?>" <?php echo e(request('priority_id') == $priority->id ? 'selected' : ''); ?>><?php echo e($priority->nom); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <table class="table align-middle table-nowrap table-hover" id="ticketsTable">
                        ...
                        <tbody>
                            ...
                            <tr class="clickable-row" data-href="<?php echo e(route('tickets.show', $ticket->id)); ?>">
                                ...
                                <td data-column="titre"><?php echo e(Str::limit($ticket->titre, 30)); ?></td>
                                ...
                                <td data-column="actions" onclick="event.stopPropagation();">
                                    <a href="<?php echo e(route('tickets.edit', $ticket->id)); ?>" class="btn btn-sm btn-outline-primary" title="Modifier"><i class="bx bx-pencil"></i></a>
                                </td>
                            </tr>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div>
                        <small class="text-muted">Affichage de <?php echo e($tickets->firstItem() ?? 0); ?> à <?php echo e($tickets->lastItem() ?? 0); ?> sur <?php echo e($tickets->total()); ?> résultats</small>
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zakar\Desktop\Admin\resources\views/tickets/index.blade.php ENDPATH**/ ?>