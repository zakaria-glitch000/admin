        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('root')); ?>">Tableau de bord</a></li>
                ...
                <div class="card-body text-center pt-4">
                    <div class="profile-user-wid mb-4 position-relative d-inline-block">
                        ...
                        <img id="profile-preview" 
                             src="<?php echo e((Auth::user()->avatar && file_exists(public_path(Auth::user()->avatar))) ? asset(Auth::user()->avatar) : asset('build/images/users/avatar-1.jpg')); ?>" 
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger font-size-12 d-block mb-2"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', Auth::user()->name)); ?>">
                        <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger font-size-12"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
                    ...
                    <div class="mb-3 text-start px-2">
                        ...
                        <input type="email" class="form-control bg-light" value="<?php echo e(Auth::user()->email); ?>" disabled>
                    </div>
                </div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Entrez le mot de passe actuel si vous changez le mot de passe">
                        <?php $__errorArgs = ['current_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger font-size-12 mt-1 d-block"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Nouveau mot de passe">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zakar\Desktop\Admin\resources\views/profile/show.blade.php ENDPATH**/ ?>