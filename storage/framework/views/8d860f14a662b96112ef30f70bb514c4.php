...
<?php $__env->startSection('title'); ?> Fiche Client - <?php echo e($client->nom_societe); ?> <?php $__env->stopSection(); ?>
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Fiche Client: <?php echo e($client->nom_societe); ?></h4>
            <div>
                <!-- زر تعديل الكلاينت -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="mb-2"><strong>Secteur:</strong> <?php echo e($client->secteur_activite ?? 'N/A'); ?></li>
                    <li class="mb-2"><strong>Téléphone:</strong> <?php echo e($client->telephone_principal); ?></li>
                    <li class="mb-2"><strong>Email:</strong> <?php echo e($client->email ?? 'N/A'); ?></li>
                    <li class="mb-2"><strong>Date Creation:</strong> <?php echo e($client->created_at->format('d/m/Y')); ?></li>
                </ul>
                <?php if($client->notes): ?>
                    <hr>
                    <h6>Notes:</h6>
                    <p class="text-muted font-size-13 mb-0"><?php echo e($client->notes); ?></p>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="tab-content p-3 text-muted">
                    ...
                    <div class="tab-pane active" id="sites_tab" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <!-- زر Export Excel -->
                            <button type="button" class="btn btn-success btn-sm" onclick="exportTableToExcel('sitesTable', 'Sites_<?php echo e($client->nom_societe); ?>')">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $client->sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td data-column="contrat">
                                                <small>
                                                    <strong><?php echo e($site->numero_contrat ?? '-'); ?></strong><br>
                                                    <?php if($site->date_debut_contrat && $site->date_fin_contrat): ?>
                                                        <?php
                                                        ...
                                                        <span class="text-muted d-block mb-1">
                                                            <?php echo e($debut->format('d/m/Y')); ?> ➔ <?php echo e($fin->format('d/m/Y')); ?>
                                            ...
                                            <td data-column="contact"><small><?php echo e($site->contact_nom ?? '-'); ?> <br>(<?php echo e($site->contact_telephone ?? '-'); ?>)</small></td>
                                            <td data-column="machines"><span class="badge bg-soft-primary text-primary"><?php echo e($site->machines->count()); ?></span></td>
                                            <td class="text-center" data-column="action">
                                                <!-- زر تعديل الفرع -->
                                                <button type="button" class="btn btn-outline-success btn-sm px-2 py-1" data-bs-toggle="modal" data-bs-target="#editSiteModal<?php echo e($site->id); ?>" title="Modifier">
                                                    <i class="bx bx-pencil"></i>
                                                </button>

                                                <!-- زر حذف الفرع -->
                                                <form action="<?php echo e(route('clients.sites.destroy', $site->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('متأكد أنك تريد حذف هذا الفرع؟');">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                        ...
                                        <div class="modal fade" id="editSiteModal<?php echo e($site->id); ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo e(route('clients.sites.update', $site->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="modal-body text-start">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="ville" class="form-control" value="<?php echo e($site->ville); ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Adresse complète <span class="text-danger">*</span></label>
                                                                <input type="text" name="adresse" class="form-control" value="<?php echo e($site->adresse); ?>" required>
                                                            </div>
                                                            <!-- حقول العقد في التعديل -->
                                                            <div class="mb-3">
                                                                <label class="form-label">Numéro de Contrat</label>
                                                                <input type="text" name="numero_contrat" class="form-control" value="<?php echo e($site->numero_contrat); ?>">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Date début contrat</label>
                                                                <input type="date" name="date_debut_contrat" class="form-control" value="<?php echo e($site->date_debut_contrat); ?>">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Date fin contrat</label>
                                                                <input type="date" name="date_fin_contrat" class="form-control" value="<?php echo e($site->date_fin_contrat); ?>">
                                                            </div>
                                                            <!-- نهاية حقول العقد -->
                                                            <div class="mb-3">
                    ...
                    <div class="tab-pane" id="tickets_tab" role="tabpanel">
                        ...
                        <form method="GET" action="<?php echo e(route('clients.show', $client->id)); ?>#tickets_tab" class="card bg-light border-0 p-3 mb-3">
                            <div class="row align-items-end g-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="date_debut" class="form-control form-control-sm" value="<?php echo e(request('date_debut')); ?>" onchange="this.form.submit()">
                                </div>

                                <!-- تاريخ النهاية -->
                                <div class="col-md-3">
                                    <label class="form-label font-size-12 mb-1">Date Fin</label>
                                    <input type="date" name="date_fin" class="form-control form-control-sm" value="<?php echo e(request('date_fin')); ?>" onchange="this.form.submit()">
                                </div>

                                <!-- زر إعادة الضبط (Reset) -->
                                <div class="col-md-2">
                                    <?php if(request('site_id') || request('date_debut') || request('date_fin')): ?>
                                        <a href="<?php echo e(route('clients.show', $client->id)); ?>#tickets_tab" class="btn btn-outline-secondary btn-sm w-100" title="Réinitialiser">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <!-- زر Export Excel -->
                            <button type="button" class="btn btn-success btn-sm" onclick="exportTableToExcel('ticketsTable', 'Tickets_<?php echo e($client->nom_societe); ?>')">
                                <i class="bx bx-file me-1"></i> Exporter Excel
                            </button>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm align-middle mb-0" id="ticketsTable">
                                ...
                                <tbody>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $ticketsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr onclick="window.location='<?php echo e(route('tickets.show', $tck)); ?>';" style="cursor: pointer;" title="Voir les détails du ticket">
                                            ...
                                            <td data-column="statut"><span class="badge bg-<?php echo e($tck->status->couleur ?? 'secondary'); ?>"><?php echo e($tck->status->nom ?? $tck->statut ?? '-'); ?></span></td>
