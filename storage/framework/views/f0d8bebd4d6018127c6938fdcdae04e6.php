                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold m-0 text-dark"><?php echo e($role->name); ?></h3>
                        </div>
                    </div>
                        ...
                        <?php if(!empty($rolePermissions) && count($rolePermissions) > 0): ?>
                            ...
                            <div class="row g-3">
                                <?php $__currentLoopData = $permissionGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $groupPerms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($hasPermissionsInGroup): ?>
                                        <div class="col-md-6">
                                            <div class="border rounded p-3 bg-light h-100">
                                                <h6 class="fw-bold text-primary mb-2 font-size-14">
                                                    <i class="bx bx-folder me-1"></i> <?php echo e($groupName); ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-edit')): ?>
                        <div class="text-end mt-4 pt-3 border-top">
                            <a href="<?php echo e(route('roles.edit', $role->id)); ?>" class="btn btn-primary px-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zakar\Desktop\Admin\resources\views/roles/show.blade.php ENDPATH**/ ?>